...
import { generate, byRequirement, fetchPublic, submit, submission, sendInvite, verifyExamIdentity, monitorExam } from '../controllers/exams.js';
...
router.post('/:examId/monitor', monitorExam);
